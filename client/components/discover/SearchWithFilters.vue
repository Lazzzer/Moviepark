              ...
              <div v-show="isOpen" class="mt-2">
                  ...
                  <div class="mb-3 sm:mt-0">
                    <div class="mt-1 rounded-md shadow-sm">
                      ...
                      >
                        ...
                        <!-- The API provide weird results with this parameter. Won't be used for now. -->
                ...
                <div class="mt-2">
                  <label
                    for="votesAverage"
                    class="block text-sm font-medium leading-5 text-gray-300"
                  >Votes Average >= <span class="text-xs italic">[0-10]</span></label>
                  <div class="mb-3 sm:mt-0">
                    <div class="mt-1 rounded-md shadow-sm">
                      <ValidationProvider v-slot="{ failed }" mode="eager" rules="between:0,10">
                        <input
                          ...
                          step="0.1"
                          type="number"
                          :class=" failed ? 'border-red-400' : 'border-transparent'"
                ...
                <button
                  @click="handleSubmit(prepareSearch)"
                  type="submit"
