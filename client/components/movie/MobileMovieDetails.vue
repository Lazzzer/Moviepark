<template>
  <div class="relative w-full text-center text-gray-300">
    <div class="relative p-8 rounded-md bg-m-blue-900">
      ...
      ></div>
      <MobileWatchListButton v-if="$auth.loggedIn" :movie-id="movieInfos.id" class="absolute z-30 left-3 bottom-3" />
      <span
...
import MobileWatchListButton from '@/components/movie/MobileWatchListButton'
