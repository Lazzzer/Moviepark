        ...
        <div v-show="open" class="absolute right-0 w-56 mt-2 origin-top-right rounded-md shadow-lg">
          <div class="rounded-md bg-m-blue-800" role="menu" aria-orientation="vertical" aria-labelledby="options-menu">
            <div class="py-1">
              ...
              <div class="flex items-center px-4 py-2 text-sm leading-5 text-gray-300 cursor-pointer group hover:bg-red-400 hover:text-white focus:outline-none focus:bg-red-400 focus:text-white" role="menuitem">
...
export default {
  ...
  computed: {
    ...mapGetters('watchlist', ['watchedMovieList']),
    ...mapState({
