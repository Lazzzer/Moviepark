            ...
            <div>
              ...
              >
                <input
                  ...
                  class="relative block w-full px-3 py-2 text-gray-300 placeholder-gray-400 border border-transparent rounded-none appearance-none bg-m-blue-900 rounded-t-md focus:outline-none focus:border-teal-700 focus:z-10 sm:text-sm sm:leading-5"
            ...
            <div class="-mt-px">
              ...
              >
                <input
                  ...
                  required
                  :class="validated && failed ? 'text-red-400' : 'text-gray-300'"
                  class="relative block w-full px-3 py-2 text-gray-300 placeholder-gray-400 border border-transparent rounded-none appearance-none bg-m-blue-900 focus:outline-none focus:border-teal-700 focus:z-10 sm:text-sm sm:leading-5"
            ...
            <div class="-mt-px">
              ...
              >
                <input
                  ...
                  required
                  :class="validated && failed ? 'text-red-400' : 'text-gray-300'"
                  class="relative block w-full px-3 py-2 text-gray-300 placeholder-gray-400 border border-transparent rounded-none appearance-none bg-m-blue-900 rounded-b-md focus:outline-none focus:border-teal-700 focus:z-10 sm:text-sm sm:leading-5"
